...
The assembly was smooth as butter. The entire electrical system was wired up and "WORKING" on my table. Check out[robot on table](). That's what I'm talking about!

Last but not least - the firmware for all the MCUs on the rover and the Bluetooth remote. Writing firmware is always fun. Even though I encountered half a million exceptions. I'm kidding. Here's the rover's [baby steps](). [Rover gone mad]() after multiple bugs in the firmware. Finally [rover in action]() after ages!
...
![Remote control no case take 1]()
![Remote control no case take 2]()
![Remote control no case with rover]()
...
<!-- Remote control in case -->
<!-- Remote control in case with rover -->
